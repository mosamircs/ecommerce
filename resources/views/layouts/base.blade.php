									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt"> Cairo Egypt</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+20) 1148630595 - (+20) 1094922240</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">mosamircs@gmail.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+20) 1148630595 - (+20) 1094922240</b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 Mohamed Samir. All rights reserved</p>
					</div>
